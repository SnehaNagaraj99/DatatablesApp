class EcomOrdersController < ApplicationController
  ...
  private
    ...
    def ecom_order_params
      params.require(:ecom_order).permit(:price, :item_sku, :purchase_date, :platform_order_num, :sales_channel, :status, :customer_name, :customer_state, :shipped_at, :number_of_items_shipped, :payment_method)
    end
end
